...
static public function getRow($id) {
        try {
            $sql = 'SELECT cod_pro,desc_prog,estado FROM programa WHERE programa.cod_pro = ' . $id;
    ...
    static public function certifyId($id) {
        try {
            $sql = "SELECT programa.cod_pro FROM programa WHERE programa.cod_pro ='$id'";
            return dataBaseClass::getInstance()->query($sql)->fetchAll(PDO::FETCH_ASSOC);
        } catch (PDOException $e) {
            return $e;
        }
    ...
    static public function deleteUsuario($id) {
        try {
            ...
            $sql = "DELETE FROM programa WHERE cod_pro ='$id'";
    ...
    static public function getAll() {
        try {
            $sql = 'SELECT cod_pro,desc_prog,estado FROM programa';
            return dataBaseClass::getInstance()->query($sql)->fetchAll(PDO::FETCH_ASSOC);
        } catch (PDOException $e) {
            return $e;
            /*
     ...
     * @return \PDOException
     */
    static public function putNewUser($id, $desc,$est) {
        try {
            $sql = "INSERT INTO programa (cod_pro,desc_prog,estado) VALUES ($id,'$desc','$est')";
