<form method="post" action="<?php echo $formAction ?>" enctype="application/x-www-form-urlencoded">
    ...
    <table border="1" align="center">
        ...
        <tr>
            <th>codigo </th><td><input type="text"  id="txtcod" name="txtcod" maxlength="10" value="<?php echo ((isset($txtcod)) ? $txtcod : '') ?>" placeholder="cod de credencial" readonly style="background: grey; color: green"></td>
        </tr>
