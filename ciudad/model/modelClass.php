...
static public function getRow($id) {
        try {
            $sql = 'SELECT cod_ciudad,nom_ciudad,cod_depto,habitantes FROM ciudad WHERE ciudad.cod_ciudad = ' . $id;
            return dataBaseClass::getInstance()->query($sql)->fetchAll(PDO::FETCH_ASSOC);
        } catch (PDOException $e) {
            return $e;
        }
     ...
     * @return \PDOException
     */
    static public function putNewUser($id, $desc, $depto,$hab) {
        try {
            $sql = "INSERT INTO ciudad (cod_ciudad,nom_ciudad,cod_depto,habitantes) VALUES ($id,'$desc',$depto,'$hab')";
