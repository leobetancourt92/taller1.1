...
class modelClass {
    ...
    static public function getRow($id) {
        try {
            $sql = 'SELECT num_ficha,id_aprendiz,estado FROM matricula WHERE matricula.id_aprendiz = ' . $id;
    ...
    static public function certifyId($id) {
        try {
            $sql = "SELECT matricula.id_aprendiz FROM matricula WHERE matricula.id_aprendiz ='$id'";
            return dataBaseClass::getInstance()->query($sql)->fetchAll(PDO::FETCH_ASSOC);
        } catch (PDOException $e) {
            return $e;
        }
    ...
    static public function deleteUsuario($id) {
        try {
            ...
            $sql = "DELETE FROM matricula WHERE id_aprendiz ='$id'";
    ...
    static public function getAll() {
        try {
            $sql = 'SELECT num_ficha,id_aprendiz,estado FROM matricula';
            return dataBaseClass::getInstance()->query($sql)->fetchAll(PDO::FETCH_ASSOC);
        } catch (PDOException $e) {
            return $e;
            /*
     ...
     * @return \PDOException
     */
    static public function putNewUser($fich, $ida, $est) {
        try {
            $sql = "INSERT INTO matricula (num_ficha,id_aprendiz,estado) VALUES ($fich,'$ida','$est')";
