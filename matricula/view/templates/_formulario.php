<form method="post" action="<?php echo $formAction ?>" enctype="application/x-www-form-urlencoded">
    ...
    <table border="1" align="center">
        ...
        <tr>
            <th>identificacion del aprendiz</th><td><input type="text" value="<?php echo ((isset($txtapre)) ? $txtapre : '') ?>" id="txtapre" name="txtapre" max="30" min=""<?php echo ($_GET['action'] === 'update') ? '' : 'required' ?> placeholder="Nombre del Aprendiz"></td>
        </tr>
